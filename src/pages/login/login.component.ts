...
export class LoginComponent implements OnInit {
  ...
  loginForm = new FormGroup({
    phoneNumberOrEmail: new FormControl<string>('quang@gmail.com', [
      Validators.required,
      Validators.email,
    ]),
  ...
  createAccount() {
    this.router.navigate(['/register']);     // Chuyển hướng người dùng đến trang đăng ký (hoặc trang tạo tài khoản)
  }
}
